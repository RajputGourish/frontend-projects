                                    ...
                                    return <tr key={index}>
                                        <td className="text-center border border-white">
                                            <div className="flex items-center justify-center">
                                                <a className="max-w-23 md:max-w-50 h-7 text-nowrap overflow-x-auto overflow-y-hidden" href={pass.site} target="_blank">{pass.site}</a>
                                        ...
                                        <td className="text-center border border-white"><div className="flex items-center justify-center max-w-23 md:max-w-50 h-7 text-nowrap overflow-x-auto overflow-y-hidden">
                                            {pass.password}
